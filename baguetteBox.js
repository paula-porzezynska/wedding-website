...
(this, function () {
    ...
    function m(t, e) {
        ...
        if ("undefined" != typeof n) {
            ...
            var o = R[t].imageElement, i = o.getElementsByTagName("img")[0],
    ...
    function y() {
        ...
        "fadeIn" === j.animation ? (P.style.opacity = 0, setTimeout(function () {
            M.transforms ? P.style.transform = P.style.webkitTransform = "translate3d(" + t + ",0,0)":P.
            style.left = t, P.style.opacity = 1
